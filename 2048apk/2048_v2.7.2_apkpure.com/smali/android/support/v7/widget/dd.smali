...
.method public a(Landroid/content/Context;Landroid/support/v7/internal/view/menu/i;)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/dd;->a:Landroid/support/v7/internal/view/menu/i;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/dd;->b:Landroid/support/v7/internal/view/menu/m;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/dd;->a:Landroid/support/v7/internal/view/menu/i;

    iget-object v1, p0, Landroid/support/v7/widget/dd;->b:Landroid/support/v7/internal/view/menu/m;

    invoke-virtual {v0, v1}, Landroid/support/v7/internal/view/menu/i;->d(Landroid/support/v7/internal/view/menu/m;)Z

    :cond_0
    iput-object p2, p0, Landroid/support/v7/widget/dd;->a:Landroid/support/v7/internal/view/menu/i;
...
.method public a(Landroid/support/v7/internal/view/menu/i;Landroid/support/v7/internal/view/menu/m;)Z
    ...
    iput-object p2, p0, Landroid/support/v7/widget/dd;->b:Landroid/support/v7/internal/view/menu/m;
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/Toolbar;->i()Landroid/support/v7/widget/de;
...
.method public b(Z)V
    ...
    iget-object v1, p0, Landroid/support/v7/widget/dd;->a:Landroid/support/v7/internal/view/menu/i;
    ...
    iget-object v3, p0, Landroid/support/v7/widget/dd;->a:Landroid/support/v7/internal/view/menu/i;

    invoke-virtual {v3, v1}, Landroid/support/v7/internal/view/menu/i;->getItem(I)Landroid/view/MenuItem;

    move-result-object v3

    iget-object v4, p0, Landroid/support/v7/widget/dd;->b:Landroid/support/v7/internal/view/menu/m;
    ...
    invoke-virtual {p0, v0, v1}, Landroid/support/v7/widget/dd;->b(Landroid/support/v7/internal/view/menu/i;Landroid/support/v7/internal/view/menu/m;)Z
...
.method public b(Landroid/support/v7/internal/view/menu/i;Landroid/support/v7/internal/view/menu/m;)Z
    ...
    iput-object v2, p0, Landroid/support/v7/widget/dd;->b:Landroid/support/v7/internal/view/menu/m;
