...
# static fields
.field static final a:Landroid/support/v7/widget/co;
...
.field private q:Landroid/support/v7/widget/cq;

.field private r:Landroid/support/v7/widget/cp;

.field private s:Landroid/view/View$OnFocusChangeListener;

.field private t:Landroid/support/v7/widget/cr;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v7/widget/SearchView;->a:Landroid/support/v7/widget/co;
...
.method private l()V
    ...
    invoke-direct {v0, v2, p0, v3, v4}, Landroid/support/v7/widget/cx;-><init>(Landroid/content/Context;Landroid/support/v7/widget/SearchView;Landroid/app/SearchableInfo;Ljava/util/WeakHashMap;)V
    ...
    :cond_2
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/cx;->a(I)V
...
.method private m()V
    ...
    iget-object v1, p0, Landroid/support/v7/widget/SearchView;->q:Landroid/support/v7/widget/cq;
    ...
    invoke-interface {v1, v2}, Landroid/support/v7/widget/cq;->a(Ljava/lang/String;)Z
...
.method private o()V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/SearchView;->r:Landroid/support/v7/widget/cp;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/SearchView;->r:Landroid/support/v7/widget/cp;

    invoke-interface {v0}, Landroid/support/v7/widget/cp;->a()Z
...
.method private q()V
    ...
    sget-object v0, Landroid/support/v7/widget/SearchView;->a:Landroid/support/v7/widget/co;

    iget-object v1, p0, Landroid/support/v7/widget/SearchView;->c:Landroid/support/v7/widget/SearchView$SearchAutoComplete;

    invoke-virtual {v0, v1}, Landroid/support/v7/widget/co;->a(Landroid/widget/AutoCompleteTextView;)V

    sget-object v0, Landroid/support/v7/widget/SearchView;->a:Landroid/support/v7/widget/co;

    iget-object v1, p0, Landroid/support/v7/widget/SearchView;->c:Landroid/support/v7/widget/SearchView$SearchAutoComplete;

    invoke-virtual {v0, v1}, Landroid/support/v7/widget/co;->b(Landroid/widget/AutoCompleteTextView;)V
...
.method public setOnCloseListener(Landroid/support/v7/widget/cp;)V
    .locals 0

    iput-object p1, p0, Landroid/support/v7/widget/SearchView;->r:Landroid/support/v7/widget/cp;
...
.method public setOnQueryTextListener(Landroid/support/v7/widget/cq;)V
    .locals 0

    iput-object p1, p0, Landroid/support/v7/widget/SearchView;->q:Landroid/support/v7/widget/cq;
...
.method public setOnSuggestionListener(Landroid/support/v7/widget/cr;)V
    .locals 0

    iput-object p1, p0, Landroid/support/v7/widget/SearchView;->t:Landroid/support/v7/widget/cr;
...
.method public setQueryRefinementEnabled(Z)V
    ...
    instance-of v0, v0, Landroid/support/v7/widget/cx;
