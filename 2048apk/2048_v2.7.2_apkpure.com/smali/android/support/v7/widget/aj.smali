...
.method static constructor <clinit>()V
    ...
    sget v1, Landroid/support/v7/a/b;->textAllCaps:I
...
.method constructor <init>(Landroid/widget/TextView;)V
    ...
    iput-object p1, p0, Landroid/support/v7/widget/aj;->c:Landroid/widget/TextView;
...
.method a(Landroid/content/Context;I)V
    ...
    invoke-virtual {p0, v1}, Landroid/support/v7/widget/aj;->a(Z)V
...
.method a(Landroid/util/AttributeSet;I)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/aj;->c:Landroid/widget/TextView;

    invoke-virtual {v0}, Landroid/widget/TextView;->getContext()Landroid/content/Context;

    move-result-object v0

    sget-object v1, Landroid/support/v7/widget/aj;->a:[I
    ...
    invoke-virtual {p0, v2}, Landroid/support/v7/widget/aj;->a(Z)V

    :cond_0
    invoke-virtual {v1}, Landroid/content/res/TypedArray;->recycle()V

    :cond_1
    sget-object v1, Landroid/support/v7/widget/aj;->b:[I
    ...
    iget-object v1, p0, Landroid/support/v7/widget/aj;->c:Landroid/widget/TextView;
    ...
    :goto_0
    iget-object v2, p0, Landroid/support/v7/widget/aj;->c:Landroid/widget/TextView;
