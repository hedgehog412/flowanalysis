...
.field private d:Landroid/support/v4/view/ej;

.field private e:Z

.field private final f:Landroid/support/v4/view/ek;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroid/support/v7/internal/view/i;->f:Landroid/support/v4/view/ek;
...
.method static synthetic a(Landroid/support/v7/internal/view/i;)Landroid/support/v4/view/ej;
    .locals 1

    iget-object v0, p0, Landroid/support/v7/internal/view/i;->d:Landroid/support/v4/view/ej;
...
.method public a(Landroid/support/v4/view/ds;)Landroid/support/v7/internal/view/i;
    .locals 1
...
.method public a(Landroid/support/v4/view/ds;Landroid/support/v4/view/ds;)Landroid/support/v7/internal/view/i;
    .locals 2
    ...
    invoke-virtual {p1}, Landroid/support/v4/view/ds;->a()J

    move-result-wide v0

    invoke-virtual {p2, v0, v1}, Landroid/support/v4/view/ds;->b(J)Landroid/support/v4/view/ds;
...
.method public a(Landroid/support/v4/view/ej;)Landroid/support/v7/internal/view/i;
    .locals 1
    ...
    iput-object p1, p0, Landroid/support/v7/internal/view/i;->d:Landroid/support/v4/view/ej;
...
.method public a()V
    ...
    invoke-virtual {v0, v2, v3}, Landroid/support/v4/view/ds;->a(J)Landroid/support/v4/view/ds;
    ...
    invoke-virtual {v0, v2}, Landroid/support/v4/view/ds;->a(Landroid/view/animation/Interpolator;)Landroid/support/v4/view/ds;

    :cond_2
    iget-object v2, p0, Landroid/support/v7/internal/view/i;->d:Landroid/support/v4/view/ej;

    if-eqz v2, :cond_3

    iget-object v2, p0, Landroid/support/v7/internal/view/i;->f:Landroid/support/v4/view/ek;

    invoke-virtual {v0, v2}, Landroid/support/v4/view/ds;->a(Landroid/support/v4/view/ej;)Landroid/support/v4/view/ds;

    :cond_3
    invoke-virtual {v0}, Landroid/support/v4/view/ds;->c()V
