...
.method public c()Landroid/support/v7/widget/av;
    .locals 1

    iget-object v0, p0, Landroid/support/v7/internal/view/menu/v;->l:Landroid/support/v7/widget/av;
...
.method public d()Z
    ...
    invoke-direct {v2, v3, v4, v5, v6}, Landroid/support/v7/widget/av;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V

    iput-object v2, p0, Landroid/support/v7/internal/view/menu/v;->l:Landroid/support/v7/widget/av;

    iget-object v2, p0, Landroid/support/v7/internal/view/menu/v;->l:Landroid/support/v7/widget/av;

    invoke-virtual {v2, p0}, Landroid/support/v7/widget/av;->a(Landroid/widget/PopupWindow$OnDismissListener;)V

    iget-object v2, p0, Landroid/support/v7/internal/view/menu/v;->l:Landroid/support/v7/widget/av;

    invoke-virtual {v2, p0}, Landroid/support/v7/widget/av;->a(Landroid/widget/AdapterView$OnItemClickListener;)V

    iget-object v2, p0, Landroid/support/v7/internal/view/menu/v;->l:Landroid/support/v7/widget/av;

    iget-object v3, p0, Landroid/support/v7/internal/view/menu/v;->f:Landroid/support/v7/internal/view/menu/w;

    invoke-virtual {v2, v3}, Landroid/support/v7/widget/av;->a(Landroid/widget/ListAdapter;)V

    iget-object v2, p0, Landroid/support/v7/internal/view/menu/v;->l:Landroid/support/v7/widget/av;

    invoke-virtual {v2, v1}, Landroid/support/v7/widget/av;->a(Z)V
    ...
    invoke-virtual {v0, v2}, Landroid/support/v7/widget/av;->d(I)V
    ...
    invoke-virtual {v0, v2}, Landroid/support/v7/widget/av;->f(I)V

    iget-object v0, p0, Landroid/support/v7/internal/view/menu/v;->l:Landroid/support/v7/widget/av;

    const/4 v2, 0x2

    invoke-virtual {v0, v2}, Landroid/support/v7/widget/av;->g(I)V
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/av;->m()Landroid/widget/ListView;
...
.method public onDismiss()V
    ...
    iput-object v1, p0, Landroid/support/v7/internal/view/menu/v;->l:Landroid/support/v7/widget/av;
