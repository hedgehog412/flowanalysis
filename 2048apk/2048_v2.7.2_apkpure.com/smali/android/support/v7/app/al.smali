.class public Landroid/support/v7/app/al;
...
.method public constructor <init>(Landroid/content/Context;I)V
    ...
    invoke-static {p1, p2}, Landroid/support/v7/app/al;->a(Landroid/content/Context;I)I

    move-result v0

    invoke-direct {p0, p1, v0}, Landroid/app/Dialog;-><init>(Landroid/content/Context;I)V

    invoke-virtual {p0}, Landroid/support/v7/app/al;->a()Landroid/support/v7/app/r;

    move-result-object v0

    const/4 v1, 0x0

    invoke-virtual {v0, v1}, Landroid/support/v7/app/r;->a(Landroid/os/Bundle;)V
...
# virtual methods
.method public a()Landroid/support/v7/app/r;
    .locals 1

    iget-object v0, p0, Landroid/support/v7/app/al;->a:Landroid/support/v7/app/r;

    if-nez v0, :cond_0

    invoke-static {p0, p0}, Landroid/support/v7/app/r;->a(Landroid/app/Dialog;Landroid/support/v7/app/q;)Landroid/support/v7/app/r;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v7/app/al;->a:Landroid/support/v7/app/r;
...
.method public a(I)Z
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/app/r;->b(I)Z
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/app/r;->a(Landroid/os/Bundle;)V
...
.method protected onStop()V
    ...
    invoke-virtual {v0}, Landroid/support/v7/app/r;->a()V
...
.method public setTitle(I)V
    ...
    invoke-virtual {p0}, Landroid/support/v7/app/al;->getContext()Landroid/content/Context;
