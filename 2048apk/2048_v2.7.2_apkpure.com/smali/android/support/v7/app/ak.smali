...
.method private constructor <init>(Landroid/support/v7/app/AppCompatDelegateImplV7;)V
    ...
    iput-object p1, p0, Landroid/support/v7/app/ak;->a:Landroid/support/v7/app/AppCompatDelegateImplV7;
...
.method synthetic constructor <init>(Landroid/support/v7/app/AppCompatDelegateImplV7;Landroid/support/v7/app/z;)V
    .locals 0

    invoke-direct {p0, p1}, Landroid/support/v7/app/ak;-><init>(Landroid/support/v7/app/AppCompatDelegateImplV7;)V
...
.method public a(Landroid/support/v7/internal/view/menu/i;Z)V
    ...
    :goto_0
    iget-object v3, p0, Landroid/support/v7/app/ak;->a:Landroid/support/v7/app/AppCompatDelegateImplV7;
    ...
    iget-object v0, p0, Landroid/support/v7/app/ak;->a:Landroid/support/v7/app/AppCompatDelegateImplV7;
...
.method public a(Landroid/support/v7/internal/view/menu/i;)Z
    ...
    invoke-virtual {v0}, Landroid/support/v7/app/AppCompatDelegateImplV7;->j()Landroid/view/Window$Callback;

    move-result-object v0

    if-eqz v0, :cond_0

    iget-object v1, p0, Landroid/support/v7/app/ak;->a:Landroid/support/v7/app/AppCompatDelegateImplV7;

    invoke-virtual {v1}, Landroid/support/v7/app/AppCompatDelegateImplV7;->i()Z
