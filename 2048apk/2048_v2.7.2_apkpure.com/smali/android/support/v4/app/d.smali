...
.method public constructor <init>(Landroid/support/v4/app/z;)V
    ...
    iput-object p1, p0, Landroid/support/v4/app/d;->b:Landroid/support/v4/app/z;
...
.method private a(Landroid/util/SparseArray;Landroid/util/SparseArray;Z)Landroid/support/v4/app/i;
    ...
    iget-object v1, p0, Landroid/support/v4/app/d;->b:Landroid/support/v4/app/z;
...
.method static synthetic a(Landroid/support/v4/app/d;Landroid/support/v4/app/i;ZLandroid/support/v4/app/Fragment;)Landroid/support/v4/f/a;
    .locals 1

    invoke-direct {p0, p1, p2, p3}, Landroid/support/v4/app/d;->a(Landroid/support/v4/app/i;ZLandroid/support/v4/app/Fragment;)Landroid/support/v4/f/a;
...
.method private a(Landroid/support/v4/app/i;Landroid/support/v4/app/Fragment;Z)Landroid/support/v4/f/a;
    .locals 4
    ...
    iget-object v1, p2, Landroid/support/v4/app/Fragment;->ah:Landroid/support/v4/app/cy;
    ...
    invoke-virtual {v1, v2, v0}, Landroid/support/v4/app/cy;->a(Ljava/util/List;Ljava/util/Map;)V
    ...
    :cond_3
    iget-object v1, p2, Landroid/support/v4/app/Fragment;->ai:Landroid/support/v4/app/cy;
...
.method private a(Landroid/support/v4/app/i;ZLandroid/support/v4/app/Fragment;)Landroid/support/v4/f/a;
    .locals 4

    const/4 v3, 0x1

    invoke-direct {p0, p1, p3, p2}, Landroid/support/v4/app/d;->b(Landroid/support/v4/app/i;Landroid/support/v4/app/Fragment;Z)Landroid/support/v4/f/a;

    move-result-object v0

    if-eqz p2, :cond_1

    iget-object v1, p3, Landroid/support/v4/app/Fragment;->ai:Landroid/support/v4/app/cy;
    ...
    :cond_1
    iget-object v1, p3, Landroid/support/v4/app/Fragment;->ah:Landroid/support/v4/app/cy;
...
.method private a(ILandroid/support/v4/app/Fragment;Ljava/lang/String;I)V
    ...
    iget-object v0, p0, Landroid/support/v4/app/d;->b:Landroid/support/v4/app/z;

    iput-object v0, p2, Landroid/support/v4/app/Fragment;->C:Landroid/support/v4/app/z;
...
.method static synthetic a(Landroid/support/v4/app/d;Landroid/support/v4/app/i;Landroid/support/v4/app/Fragment;Landroid/support/v4/app/Fragment;ZLandroid/support/v4/f/a;)V
    .locals 0

    invoke-direct/range {p0 .. p5}, Landroid/support/v4/app/d;->a(Landroid/support/v4/app/i;Landroid/support/v4/app/Fragment;Landroid/support/v4/app/Fragment;ZLandroid/support/v4/f/a;)V
...
.method private a(Landroid/support/v4/app/i;Landroid/support/v4/app/Fragment;Landroid/support/v4/app/Fragment;ZLandroid/support/v4/f/a;)V
    .locals 4

    if-eqz p4, :cond_1

    iget-object v0, p3, Landroid/support/v4/app/Fragment;->ah:Landroid/support/v4/app/cy;
    ...
    invoke-virtual {v0, v1, v2, v3}, Landroid/support/v4/app/cy;->b(Ljava/util/List;Ljava/util/List;Ljava/util/List;)V

    :cond_0
    return-void

    :cond_1
    iget-object v0, p2, Landroid/support/v4/app/Fragment;->ah:Landroid/support/v4/app/cy;
...
.method private a(ILandroid/support/v4/app/i;ZLandroid/util/SparseArray;Landroid/util/SparseArray;)Z
    ...
    iget-object v4, v0, Landroid/support/v4/app/d;->b:Landroid/support/v4/app/z;
    ...
    invoke-direct {v0, v1, v9, v2}, Landroid/support/v4/app/d;->a(Landroid/support/v4/app/i;Landroid/support/v4/app/Fragment;Z)Landroid/support/v4/f/a;
    ...
    iget-object v4, v9, Landroid/support/v4/app/Fragment;->ah:Landroid/support/v4/app/cy;
    ...
    invoke-virtual {v4, v5, v10, v13}, Landroid/support/v4/app/cy;->a(Ljava/util/List;Ljava/util/List;Ljava/util/List;)V
    ...
    :cond_4
    iget-object v4, v8, Landroid/support/v4/app/Fragment;->ah:Landroid/support/v4/app/cy;
    ...
    invoke-static {v14, v9, v0, v1, v4}, Landroid/support/v4/app/d;->a(Ljava/lang/Object;Landroid/support/v4/app/Fragment;Ljava/util/ArrayList;Landroid/support/v4/f/a;Landroid/view/View;)Ljava/lang/Object;
    ...
    invoke-static {v13, v4}, Landroid/support/v4/app/an;->a(Ljava/lang/Object;Landroid/view/View;)V
    ...
    invoke-static {v12, v0, v13, v4}, Landroid/support/v4/app/an;->a(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Z)Ljava/lang/Object;
    ...
    invoke-static/range {v12 .. v22}, Landroid/support/v4/app/an;->a(Ljava/lang/Object;Ljava/lang/Object;Landroid/view/View;Landroid/support/v4/app/at;Landroid/view/View;Landroid/support/v4/app/as;Ljava/util/Map;Ljava/util/ArrayList;Ljava/util/Map;Ljava/util/Map;Ljava/util/ArrayList;)V
    ...
    invoke-static/range {v22 .. v32}, Landroid/support/v4/app/an;->a(Landroid/view/View;Landroid/view/View;Ljava/lang/Object;Ljava/util/ArrayList;Ljava/lang/Object;Ljava/util/ArrayList;Ljava/lang/Object;Ljava/util/ArrayList;Ljava/lang/Object;Ljava/util/ArrayList;Ljava/util/Map;)V
...
.method private b(Landroid/support/v4/app/i;Landroid/support/v4/app/Fragment;Z)Landroid/support/v4/f/a;
    .locals 3
...
.method public a(ILandroid/support/v4/app/Fragment;Ljava/lang/String;)Landroid/support/v4/app/am;
    .locals 1
...
.method public a(Landroid/support/v4/app/Fragment;)Landroid/support/v4/app/am;
    .locals 2
...
.method public a(Landroid/support/v4/app/Fragment;Ljava/lang/String;)Landroid/support/v4/app/am;
    .locals 2
...
.method public a(ZLandroid/support/v4/app/i;Landroid/util/SparseArray;Landroid/util/SparseArray;)Landroid/support/v4/app/i;
    ...
    :pswitch_0
    iget-object v3, v6, Landroid/support/v4/app/h;->d:Landroid/support/v4/app/Fragment;
    ...
    iget-object v8, p0, Landroid/support/v4/app/d;->b:Landroid/support/v4/app/z;
    ...
    :pswitch_2
    iget-object v0, v6, Landroid/support/v4/app/h;->d:Landroid/support/v4/app/Fragment;

    iput v5, v0, Landroid/support/v4/app/Fragment;->Q:I

    iget-object v3, p0, Landroid/support/v4/app/d;->b:Landroid/support/v4/app/z;
    ...
    iget-object v2, p0, Landroid/support/v4/app/d;->b:Landroid/support/v4/app/z;
...
.method a(I)V
    ...
    iget-object v3, v2, Landroid/support/v4/app/h;->d:Landroid/support/v4/app/Fragment;
...
.method public b(Landroid/support/v4/app/Fragment;)Landroid/support/v4/app/am;
    .locals 2
...
.method public c(Landroid/support/v4/app/Fragment;)Landroid/support/v4/app/am;
    .locals 2
...
.method public run()V
    ...
    iput-object v4, v6, Landroid/support/v4/app/h;->d:Landroid/support/v4/app/Fragment;
    ...
    :cond_b
    iget-object v10, p0, Landroid/support/v4/app/d;->b:Landroid/support/v4/app/z;
