...
.method private a()V
    ...
    :try_start_0
    sget-object v1, Lcom/google/android/gms/analytics/e;->a:Ljava/lang/Object;
    ...
    :try_start_1
    sget-object v0, Lcom/google/android/gms/analytics/e;->b:Lcom/google/android/gms/d/wc;

    if-eqz v0, :cond_0

    invoke-virtual {v0}, Lcom/google/android/gms/d/wc;->b()Z

    move-result v2

    if-eqz v2, :cond_0

    invoke-virtual {v0}, Lcom/google/android/gms/d/wc;->a()V
...
.method public static a(Landroid/content/Context;)Z
    ...
    sget-object v0, Lcom/google/android/gms/analytics/f;->b:Ljava/lang/Boolean;
    ...
    :cond_0
    const-class v0, Lcom/google/android/gms/analytics/f;
    ...
    sput-object v1, Lcom/google/android/gms/analytics/f;->b:Ljava/lang/Boolean;
...
.method private b()Landroid/os/Handler;
    ...
    iget-object v0, p0, Lcom/google/android/gms/analytics/f;->a:Landroid/os/Handler;

    if-nez v0, :cond_0

    new-instance v0, Landroid/os/Handler;

    invoke-virtual {p0}, Lcom/google/android/gms/analytics/f;->getMainLooper()Landroid/os/Looper;

    move-result-object v1

    invoke-direct {v0, v1}, Landroid/os/Handler;-><init>(Landroid/os/Looper;)V

    iput-object v0, p0, Lcom/google/android/gms/analytics/f;->a:Landroid/os/Handler;
...
.method protected a(Lcom/google/android/gms/analytics/internal/j;Landroid/os/Handler;I)V
    ...
    invoke-direct {v0, p0, p3, p1}, Lcom/google/android/gms/analytics/i;-><init>(Lcom/google/android/gms/analytics/f;ILcom/google/android/gms/analytics/internal/j;)V
...
.method public onStartCommand(Landroid/content/Intent;II)I
    ...
    invoke-direct {p0}, Lcom/google/android/gms/analytics/f;->a()V
    ...
    invoke-virtual {v1}, Lcom/google/android/gms/analytics/internal/ab;->e()Lcom/google/android/gms/analytics/internal/bb;

    move-result-object v3

    invoke-virtual {v3}, Lcom/google/android/gms/analytics/internal/bb;->a()Z
    ...
    :goto_0
    invoke-direct {p0}, Lcom/google/android/gms/analytics/f;->b()Landroid/os/Handler;
    ...
    :cond_0
    invoke-virtual {v1}, Lcom/google/android/gms/analytics/internal/ab;->h()Lcom/google/android/gms/d/va;

    move-result-object v0

    new-instance v1, Lcom/google/android/gms/analytics/g;

    invoke-direct {v1, p0, v2, v3, p3}, Lcom/google/android/gms/analytics/g;-><init>(Lcom/google/android/gms/analytics/f;Lcom/google/android/gms/analytics/internal/j;Landroid/os/Handler;I)V
    ...
    invoke-virtual {v4}, Lcom/google/android/gms/analytics/internal/bb;->e()I
    ...
    new-instance v4, Lcom/google/android/gms/analytics/h;

    invoke-direct {v4, p0, v2, v3, p3}, Lcom/google/android/gms/analytics/h;-><init>(Lcom/google/android/gms/analytics/f;Lcom/google/android/gms/analytics/internal/j;Landroid/os/Handler;I)V
