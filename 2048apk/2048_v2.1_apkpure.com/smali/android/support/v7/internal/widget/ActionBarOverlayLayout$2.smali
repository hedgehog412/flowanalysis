...
.method public run()V
    ...
    invoke-static {v1}, Landroid/support/v4/g/u;->i(Landroid/view/View;)Landroid/support/v4/g/af;

    move-result-object v1

    const/4 v2, 0x0

    invoke-virtual {v1, v2}, Landroid/support/v4/g/af;->b(F)Landroid/support/v4/g/af;
    ...
    invoke-static {v2}, Landroid/support/v7/internal/widget/ActionBarOverlayLayout;->b(Landroid/support/v7/internal/widget/ActionBarOverlayLayout;)Landroid/support/v4/g/ai;

    move-result-object v2

    invoke-virtual {v1, v2}, Landroid/support/v4/g/af;->a(Landroid/support/v4/g/ai;)Landroid/support/v4/g/af;

    move-result-object v1

    invoke-static {v0, v1}, Landroid/support/v7/internal/widget/ActionBarOverlayLayout;->a(Landroid/support/v7/internal/widget/ActionBarOverlayLayout;Landroid/support/v4/g/af;)Landroid/support/v4/g/af;
