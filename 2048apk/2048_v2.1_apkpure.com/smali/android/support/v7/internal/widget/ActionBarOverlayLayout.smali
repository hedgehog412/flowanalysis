...
.field private final B:Landroid/support/v4/g/p;
...
.field private w:Landroid/support/v4/widget/m;

.field private x:Landroid/support/v4/g/af;

.field private final y:Landroid/support/v4/g/ai;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object v0, p0, Landroid/support/v7/internal/widget/ActionBarOverlayLayout;->y:Landroid/support/v4/g/ai;
    ...
    invoke-direct {v0, p0}, Landroid/support/v4/g/p;-><init>(Landroid/view/ViewGroup;)V

    iput-object v0, p0, Landroid/support/v7/internal/widget/ActionBarOverlayLayout;->B:Landroid/support/v4/g/p;

    return-void
.end method

.method static synthetic a(Landroid/support/v7/internal/widget/ActionBarOverlayLayout;Landroid/support/v4/g/af;)Landroid/support/v4/g/af;
    .locals 0

    iput-object p1, p0, Landroid/support/v7/internal/widget/ActionBarOverlayLayout;->x:Landroid/support/v4/g/af;
...
.method private a(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Landroid/support/v7/internal/widget/ActionBarOverlayLayout;->w:Landroid/support/v4/widget/m;
...
.method private a(FF)Z
    ...
    iget-object v0, p0, Landroid/support/v7/internal/widget/ActionBarOverlayLayout;->w:Landroid/support/v4/widget/m;
...
.method static synthetic b(Landroid/support/v7/internal/widget/ActionBarOverlayLayout;)Landroid/support/v4/g/ai;
    .locals 1

    iget-object v0, p0, Landroid/support/v7/internal/widget/ActionBarOverlayLayout;->y:Landroid/support/v4/g/ai;
...
.method private c()V
    ...
    iget-object v0, p0, Landroid/support/v7/internal/widget/ActionBarOverlayLayout;->x:Landroid/support/v4/g/af;
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    invoke-static {v2}, Landroid/support/v4/g/u;->g(Landroid/view/View;)F
...
.method protected fitSystemWindows(Landroid/graphics/Rect;)Z
    ...
    invoke-static {p0}, Landroid/support/v4/g/u;->j(Landroid/view/View;)I
...
.method public getActionBarHideOffset()I
    ...
    invoke-static {v0}, Landroid/support/v4/g/u;->g(Landroid/view/View;)F
...
.method public getNestedScrollAxes()I
    ...
    iget-object v0, p0, Landroid/support/v7/internal/widget/ActionBarOverlayLayout;->B:Landroid/support/v4/g/p;
...
.method protected onMeasure(II)V
    ...
    invoke-static {v0}, Landroid/support/v4/g/u;->c(Landroid/view/View;)I
    ...
    invoke-static {v2}, Landroid/support/v4/g/u;->c(Landroid/view/View;)I
    ...
    invoke-static {v1, p1, v2}, Landroid/support/v4/g/u;->a(III)I

    move-result v1

    shl-int/lit8 v2, v2, 0x10

    invoke-static {v0, p2, v2}, Landroid/support/v4/g/u;->a(III)I
...
.method public setActionBarHideOffset(I)V
    ...
    invoke-static {v1, v0}, Landroid/support/v4/g/u;->b(Landroid/view/View;F)V
