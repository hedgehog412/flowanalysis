...
.field private l:Landroid/support/v7/widget/h;
...
.method public c()Landroid/support/v7/widget/h;
    .locals 1

    iget-object v0, p0, Landroid/support/v7/internal/view/menu/i;->l:Landroid/support/v7/widget/h;
...
.method public d()Z
    ...
    invoke-direct {v2, v3, v4, v5, v6}, Landroid/support/v7/widget/h;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V

    iput-object v2, p0, Landroid/support/v7/internal/view/menu/i;->l:Landroid/support/v7/widget/h;

    iget-object v2, p0, Landroid/support/v7/internal/view/menu/i;->l:Landroid/support/v7/widget/h;

    invoke-virtual {v2, p0}, Landroid/support/v7/widget/h;->a(Landroid/widget/PopupWindow$OnDismissListener;)V

    iget-object v2, p0, Landroid/support/v7/internal/view/menu/i;->l:Landroid/support/v7/widget/h;

    invoke-virtual {v2, p0}, Landroid/support/v7/widget/h;->a(Landroid/widget/AdapterView$OnItemClickListener;)V

    iget-object v2, p0, Landroid/support/v7/internal/view/menu/i;->l:Landroid/support/v7/widget/h;

    iget-object v3, p0, Landroid/support/v7/internal/view/menu/i;->f:Landroid/support/v7/internal/view/menu/i$a;

    invoke-virtual {v2, v3}, Landroid/support/v7/widget/h;->a(Landroid/widget/ListAdapter;)V

    iget-object v2, p0, Landroid/support/v7/internal/view/menu/i;->l:Landroid/support/v7/widget/h;

    invoke-virtual {v2, v1}, Landroid/support/v7/widget/h;->a(Z)V
    ...
    invoke-virtual {v0, v2}, Landroid/support/v7/widget/h;->a(Landroid/view/View;)V

    iget-object v0, p0, Landroid/support/v7/internal/view/menu/i;->l:Landroid/support/v7/widget/h;

    iget v2, p0, Landroid/support/v7/internal/view/menu/i;->r:I

    invoke-virtual {v0, v2}, Landroid/support/v7/widget/h;->d(I)V
    ...
    invoke-virtual {v0, v2}, Landroid/support/v7/widget/h;->f(I)V

    iget-object v0, p0, Landroid/support/v7/internal/view/menu/i;->l:Landroid/support/v7/widget/h;

    const/4 v2, 0x2

    invoke-virtual {v0, v2}, Landroid/support/v7/widget/h;->g(I)V
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/h;->m()Landroid/widget/ListView;
...
.method public onDismiss()V
    ...
    iput-object v1, p0, Landroid/support/v7/internal/view/menu/i;->l:Landroid/support/v7/widget/h;
