...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget-object v0, Landroid/support/design/a$f;->SnackbarLayout:[I

    invoke-virtual {p1, p2, v0}, Landroid/content/Context;->obtainStyledAttributes(Landroid/util/AttributeSet;[I)Landroid/content/res/TypedArray;

    move-result-object v0

    sget v1, Landroid/support/design/a$f;->SnackbarLayout_android_maxWidth:I
    ...
    sget v1, Landroid/support/design/a$f;->SnackbarLayout_maxActionInlineWidth:I
    ...
    sget v1, Landroid/support/design/a$f;->SnackbarLayout_elevation:I
    ...
    invoke-static {p0, v1}, Landroid/support/v4/g/u;->d(Landroid/view/View;F)V
...
.method private static a(Landroid/view/View;II)V
    ...
    invoke-static {p0}, Landroid/support/v4/g/u;->o(Landroid/view/View;)Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-static {p0}, Landroid/support/v4/g/u;->d(Landroid/view/View;)I

    move-result v0

    invoke-static {p0}, Landroid/support/v4/g/u;->e(Landroid/view/View;)I

    move-result v1

    invoke-static {p0, v0, p1, v1, p2}, Landroid/support/v4/g/u;->a(Landroid/view/View;IIII)V
...
.method a(II)V
    ...
    invoke-static {v0, v1}, Landroid/support/v4/g/u;->c(Landroid/view/View;F)V
    ...
    invoke-virtual {v0, v4}, Landroid/support/v4/g/af;->a(F)Landroid/support/v4/g/af;
    ...
    invoke-virtual {v0, v2, v3}, Landroid/support/v4/g/af;->b(J)Landroid/support/v4/g/af;
...
.method b(II)V
    ...
    invoke-static {v0, v4}, Landroid/support/v4/g/u;->c(Landroid/view/View;F)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v4/g/af;->a(F)Landroid/support/v4/g/af;
