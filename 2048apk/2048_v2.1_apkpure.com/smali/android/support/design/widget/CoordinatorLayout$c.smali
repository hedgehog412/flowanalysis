...
.method public constructor <init>(II)V
    ...
    iput-object v0, p0, Landroid/support/design/widget/CoordinatorLayout$c;->i:Landroid/graphics/Rect;
...
.method constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget-object v0, Landroid/support/design/a$f;->CoordinatorLayout_LayoutParams:[I

    invoke-virtual {p1, p2, v0}, Landroid/content/Context;->obtainStyledAttributes(Landroid/util/AttributeSet;[I)Landroid/content/res/TypedArray;

    move-result-object v0

    sget v1, Landroid/support/design/a$f;->CoordinatorLayout_LayoutParams_android_layout_gravity:I
    ...
    sget v1, Landroid/support/design/a$f;->CoordinatorLayout_LayoutParams_layout_anchor:I
    ...
    sget v1, Landroid/support/design/a$f;->CoordinatorLayout_LayoutParams_layout_anchorGravity:I
    ...
    sget v1, Landroid/support/design/a$f;->CoordinatorLayout_LayoutParams_layout_keyline:I
    ...
    sget v1, Landroid/support/design/a$f;->CoordinatorLayout_LayoutParams_layout_behavior:I
...
.method private a(Landroid/view/View;Landroid/support/design/widget/CoordinatorLayout;)V
    ...
    iput-object v0, p0, Landroid/support/design/widget/CoordinatorLayout$c;->g:Landroid/view/View;

    iget-object v0, p0, Landroid/support/design/widget/CoordinatorLayout$c;->g:Landroid/view/View;

    if-eqz v0, :cond_4

    iget-object v0, p0, Landroid/support/design/widget/CoordinatorLayout$c;->g:Landroid/view/View;

    iget-object v1, p0, Landroid/support/design/widget/CoordinatorLayout$c;->g:Landroid/view/View;
    ...
    iput-object v3, p0, Landroid/support/design/widget/CoordinatorLayout$c;->h:Landroid/view/View;

    iput-object v3, p0, Landroid/support/design/widget/CoordinatorLayout$c;->g:Landroid/view/View;
    ...
    :cond_3
    iput-object v0, p0, Landroid/support/design/widget/CoordinatorLayout$c;->h:Landroid/view/View;
...
.method a(Landroid/graphics/Rect;)V
    ...
    iget-object v0, p0, Landroid/support/design/widget/CoordinatorLayout$c;->i:Landroid/graphics/Rect;
...
.method public a(Landroid/support/design/widget/CoordinatorLayout$a;)V
    ...
    iput-object v0, p0, Landroid/support/design/widget/CoordinatorLayout$c;->j:Ljava/lang/Object;
...
.method a(Z)V
    ...
    iput-boolean p1, p0, Landroid/support/design/widget/CoordinatorLayout$c;->l:Z
...
.method a(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;)Z
    ...
    iget-boolean v0, p0, Landroid/support/design/widget/CoordinatorLayout$c;->k:Z
    ...
    :cond_0
    iget-boolean v1, p0, Landroid/support/design/widget/CoordinatorLayout$c;->k:Z
    ...
    invoke-virtual {v0, p1, p2}, Landroid/support/design/widget/CoordinatorLayout$a;->d(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;)Z
    ...
    iput-boolean v0, p0, Landroid/support/design/widget/CoordinatorLayout$c;->k:Z
...
.method a(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;)Z
    ...
    iget-object v0, p0, Landroid/support/design/widget/CoordinatorLayout$c;->h:Landroid/view/View;
...
.method b(Z)V
    ...
    iput-boolean p1, p0, Landroid/support/design/widget/CoordinatorLayout$c;->m:Z
...
.method g()V
    ...
    iput-boolean v0, p0, Landroid/support/design/widget/CoordinatorLayout$c;->l:Z
...
.method h()Z
    ...
    iget-boolean v0, p0, Landroid/support/design/widget/CoordinatorLayout$c;->l:Z
...
.method i()Z
    ...
    iget-boolean v0, p0, Landroid/support/design/widget/CoordinatorLayout$c;->m:Z
...
.method j()V
    ...
    iput-boolean v0, p0, Landroid/support/design/widget/CoordinatorLayout$c;->m:Z
