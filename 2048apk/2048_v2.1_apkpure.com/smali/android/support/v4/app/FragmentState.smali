...
.method public constructor <init>(Landroid/support/v4/app/j;)V
    ...
    iget-object v0, p1, Landroid/support/v4/app/j;->I:Ljava/lang/String;

    iput-object v0, p0, Landroid/support/v4/app/FragmentState;->f:Ljava/lang/String;

    iget-boolean v0, p1, Landroid/support/v4/app/j;->L:Z
    ...
    iget-object v0, p1, Landroid/support/v4/app/j;->r:Landroid/os/Bundle;
...
# virtual methods
.method public a(Landroid/support/v4/app/n;Landroid/support/v4/app/j;Landroid/support/v4/app/q;)Landroid/support/v4/app/j;
    .locals 3

    iget-object v0, p0, Landroid/support/v4/app/FragmentState;->l:Landroid/support/v4/app/j;
    ...
    invoke-static {v0, v1, v2}, Landroid/support/v4/app/j;->a(Landroid/content/Context;Ljava/lang/String;Landroid/os/Bundle;)Landroid/support/v4/app/j;

    move-result-object v1

    iput-object v1, p0, Landroid/support/v4/app/FragmentState;->l:Landroid/support/v4/app/j;
    ...
    iput-object v1, v0, Landroid/support/v4/app/j;->n:Landroid/os/Bundle;
    ...
    invoke-virtual {v0, v1, p2}, Landroid/support/v4/app/j;->a(ILandroid/support/v4/app/j;)V

    iget-object v0, p0, Landroid/support/v4/app/FragmentState;->l:Landroid/support/v4/app/j;

    iget-boolean v1, p0, Landroid/support/v4/app/FragmentState;->c:Z

    iput-boolean v1, v0, Landroid/support/v4/app/j;->x:Z

    iget-object v0, p0, Landroid/support/v4/app/FragmentState;->l:Landroid/support/v4/app/j;

    const/4 v1, 0x1

    iput-boolean v1, v0, Landroid/support/v4/app/j;->z:Z

    iget-object v0, p0, Landroid/support/v4/app/FragmentState;->l:Landroid/support/v4/app/j;

    iget v1, p0, Landroid/support/v4/app/FragmentState;->d:I

    iput v1, v0, Landroid/support/v4/app/j;->G:I

    iget-object v0, p0, Landroid/support/v4/app/FragmentState;->l:Landroid/support/v4/app/j;

    iget v1, p0, Landroid/support/v4/app/FragmentState;->e:I

    iput v1, v0, Landroid/support/v4/app/j;->H:I

    iget-object v0, p0, Landroid/support/v4/app/FragmentState;->l:Landroid/support/v4/app/j;

    iget-object v1, p0, Landroid/support/v4/app/FragmentState;->f:Ljava/lang/String;

    iput-object v1, v0, Landroid/support/v4/app/j;->I:Ljava/lang/String;

    iget-object v0, p0, Landroid/support/v4/app/FragmentState;->l:Landroid/support/v4/app/j;

    iget-boolean v1, p0, Landroid/support/v4/app/FragmentState;->g:Z

    iput-boolean v1, v0, Landroid/support/v4/app/j;->L:Z
    ...
    iput-boolean v1, v0, Landroid/support/v4/app/j;->J:Z

    iget-object v0, p0, Landroid/support/v4/app/FragmentState;->l:Landroid/support/v4/app/j;

    iget-object v1, p1, Landroid/support/v4/app/n;->d:Landroid/support/v4/app/p;

    iput-object v1, v0, Landroid/support/v4/app/j;->B:Landroid/support/v4/app/p;
    ...
    iget-object v2, p0, Landroid/support/v4/app/FragmentState;->l:Landroid/support/v4/app/j;
    ...
    iput-object p3, v0, Landroid/support/v4/app/j;->E:Landroid/support/v4/app/q;
