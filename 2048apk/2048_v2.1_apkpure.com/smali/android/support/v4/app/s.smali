...
.method public static a(Ljava/lang/Object;Landroid/view/View;Ljava/util/ArrayList;Ljava/util/Map;Landroid/view/View;)Ljava/lang/Object;
    ...
    invoke-static {p2, p1}, Landroid/support/v4/app/s;->b(Ljava/util/ArrayList;Landroid/view/View;)V
    ...
    invoke-static {v0, p2}, Landroid/support/v4/app/s;->b(Ljava/lang/Object;Ljava/util/ArrayList;)V
...
.method private static a(Landroid/transition/Transition;Landroid/support/v4/app/s$a;)V
    .locals 1
    ...
    invoke-direct {v0, p1}, Landroid/support/v4/app/s$3;-><init>(Landroid/support/v4/app/s$a;)V
...
.method static synthetic a(Landroid/transition/Transition;Landroid/transition/Transition;Ljava/util/ArrayList;Z)V
    ...
    invoke-static {p0, p1, p2, p3}, Landroid/support/v4/app/s;->b(Landroid/transition/Transition;Landroid/transition/Transition;Ljava/util/ArrayList;Z)V
...
.method public static a(Ljava/lang/Object;Landroid/view/View;)V
    ...
    invoke-static {p1}, Landroid/support/v4/app/s;->c(Landroid/view/View;)Landroid/graphics/Rect;
...
.method public static a(Ljava/lang/Object;Landroid/view/View;Ljava/util/Map;Ljava/util/ArrayList;)V
    ...
    invoke-static {p0, p3}, Landroid/support/v4/app/s;->b(Ljava/lang/Object;Ljava/util/ArrayList;)V
...
.method public static a(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Landroid/view/View;Landroid/support/v4/app/s$b;Landroid/view/View;Landroid/support/v4/app/s$a;Ljava/util/Map;Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/util/Map;Ljava/util/Map;Ljava/util/ArrayList;)V
    .locals 13
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {v5, v11, v0, v4}, Landroid/support/v4/app/s;->b(Landroid/transition/Transition;Landroid/transition/Transition;Ljava/util/ArrayList;Z)V
    ...
    invoke-static {v3, v0, v1, v2}, Landroid/support/v4/app/s;->a(Ljava/lang/Object;Landroid/view/View;Ljava/util/Map;Ljava/util/ArrayList;)V

    const/4 v4, 0x1

    move-object/from16 v0, p12

    invoke-static {v5, v3, v0, v4}, Landroid/support/v4/app/s;->b(Landroid/transition/Transition;Landroid/transition/Transition;Ljava/util/ArrayList;Z)V

    const/4 v4, 0x1

    move-object/from16 v0, p12

    invoke-static {v11, v3, v0, v4}, Landroid/support/v4/app/s;->b(Landroid/transition/Transition;Landroid/transition/Transition;Ljava/util/ArrayList;Z)V
    ...
    new-instance v3, Landroid/support/v4/app/s$2;
    ...
    invoke-direct/range {v3 .. v11}, Landroid/support/v4/app/s$2;-><init>(Landroid/view/View;Landroid/transition/Transition;Landroid/view/View;Landroid/support/v4/app/s$b;Ljava/util/Map;Ljava/util/Map;Ljava/util/ArrayList;Landroid/transition/Transition;)V
    ...
    invoke-static {v5, v0}, Landroid/support/v4/app/s;->a(Landroid/transition/Transition;Landroid/support/v4/app/s$a;)V
...
.method public static a(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/util/ArrayList;Z)V
    ...
    invoke-static {p0, p2, p3, p4}, Landroid/support/v4/app/s;->b(Landroid/transition/Transition;Landroid/transition/Transition;Ljava/util/ArrayList;Z)V

    invoke-static {p1, p2, p3, p4}, Landroid/support/v4/app/s;->b(Landroid/transition/Transition;Landroid/transition/Transition;Ljava/util/ArrayList;Z)V
...
.method static synthetic a(Ljava/util/ArrayList;Landroid/view/View;)V
    ...
    invoke-static {p0, p1}, Landroid/support/v4/app/s;->b(Ljava/util/ArrayList;Landroid/view/View;)V
...
.method static synthetic b(Landroid/view/View;)Landroid/graphics/Rect;
    ...
    invoke-static {p0}, Landroid/support/v4/app/s;->c(Landroid/view/View;)Landroid/graphics/Rect;
...
.method public static b(Ljava/lang/Object;Ljava/util/ArrayList;)V
    ...
    invoke-static {v2, p1}, Landroid/support/v4/app/s;->b(Ljava/lang/Object;Ljava/util/ArrayList;)V
...
.method private static b(Ljava/util/ArrayList;Landroid/view/View;)V
    ...
    invoke-static {p0, v2}, Landroid/support/v4/app/s;->b(Ljava/util/ArrayList;Landroid/view/View;)V
