...
# instance fields
.field private a:Lcom/google/android/gms/b/tq;
...
.method private a()V
    ...
    iget-object v0, p0, Lcom/google/android/gms/ads/AdActivity;->a:Lcom/google/android/gms/b/tq;
    ...
    invoke-interface {v0}, Lcom/google/android/gms/b/tq;->l()V
    :try_end_0
...
.method protected onActivityResult(IILandroid/content/Intent;)V
    ...
    invoke-interface {v0, p1, p2, p3}, Lcom/google/android/gms/b/tq;->a(IILandroid/content/Intent;)V
    :try_end_0
...
.method public onBackPressed()V
    ...
    :try_start_0
    iget-object v1, p0, Lcom/google/android/gms/ads/AdActivity;->a:Lcom/google/android/gms/b/tq;

    if-eqz v1, :cond_0

    iget-object v1, p0, Lcom/google/android/gms/ads/AdActivity;->a:Lcom/google/android/gms/b/tq;

    invoke-interface {v1}, Lcom/google/android/gms/b/tq;->e()Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    invoke-interface {v0, v1}, Lcom/google/android/gms/b/tq;->a(Lcom/google/android/gms/a/a;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {v0, p0}, Lcom/google/android/gms/b/nc;->b(Landroid/app/Activity;)Lcom/google/android/gms/b/tq;

    move-result-object v0

    iput-object v0, p0, Lcom/google/android/gms/ads/AdActivity;->a:Lcom/google/android/gms/b/tq;
    ...
    invoke-interface {v0, p1}, Lcom/google/android/gms/b/tq;->a(Landroid/os/Bundle;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method protected onDestroy()V
    ...
    invoke-interface {v0}, Lcom/google/android/gms/b/tq;->k()V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method protected onPause()V
    ...
    invoke-interface {v0}, Lcom/google/android/gms/b/tq;->i()V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method protected onRestart()V
    ...
    invoke-interface {v0}, Lcom/google/android/gms/b/tq;->f()V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method protected onResume()V
    ...
    invoke-interface {v0}, Lcom/google/android/gms/b/tq;->h()V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method protected onSaveInstanceState(Landroid/os/Bundle;)V
    ...
    invoke-interface {v0, p1}, Lcom/google/android/gms/b/tq;->b(Landroid/os/Bundle;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method protected onStart()V
    ...
    invoke-interface {v0}, Lcom/google/android/gms/b/tq;->g()V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method protected onStop()V
    ...
    invoke-interface {v0}, Lcom/google/android/gms/b/tq;->j()V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
