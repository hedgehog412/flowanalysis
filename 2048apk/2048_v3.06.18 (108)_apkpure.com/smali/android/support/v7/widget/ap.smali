...
.method constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ap;->f:[I
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ap;->b:Landroid/view/View;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ap;->c:Landroid/widget/TextView;

    .line 62
    iget-object v0, p0, Landroid/support/v7/widget/ap;->d:Landroid/view/WindowManager$LayoutParams;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/ap;->a:Landroid/content/Context;
...
.method private a(Landroid/view/View;IIZLandroid/view/WindowManager$LayoutParams;)V
    ...
    .line 130
    iget-object v3, p0, Landroid/support/v7/widget/ap;->a:Landroid/content/Context;
    ...
    .line 138
    :cond_3
    iget-object v3, p0, Landroid/support/v7/widget/ap;->e:Landroid/graphics/Rect;
    ...
    .line 151
    iget-object v7, p0, Landroid/support/v7/widget/ap;->e:Landroid/graphics/Rect;
    ...
    .line 153
    :cond_4
    iget-object v3, p0, Landroid/support/v7/widget/ap;->g:[I
    ...
    iget-object v6, p0, Landroid/support/v7/widget/ap;->g:[I
    ...
    iget-object v5, p0, Landroid/support/v7/widget/ap;->e:Landroid/graphics/Rect;
    ...
    .line 163
    iget-object v3, p0, Landroid/support/v7/widget/ap;->b:Landroid/view/View;
...
.method a(Landroid/view/View;IIZLjava/lang/CharSequence;)V
    ...
    .line 81
    iget-object v5, p0, Landroid/support/v7/widget/ap;->d:Landroid/view/WindowManager$LayoutParams;
    ...
    invoke-direct/range {v0 .. v5}, Landroid/support/v7/widget/ap;->a(Landroid/view/View;IIZLandroid/view/WindowManager$LayoutParams;)V
    ...
    iget-object v2, p0, Landroid/support/v7/widget/ap;->d:Landroid/view/WindowManager$LayoutParams;
