...
.method public constructor <init>(Landroid/support/v7/widget/ae;Landroid/content/Context;Landroid/support/v7/app/a$b;Z)V
    ...
    invoke-direct {p0, p2, v3, v0}, Landroid/support/v7/widget/x;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ae$c;->b:[I

    .line 390
    iput-object p3, p0, Landroid/support/v7/widget/ae$c;->c:Landroid/support/v7/app/a$b;

    .line 392
    iget-object v0, p0, Landroid/support/v7/widget/ae$c;->b:[I

    sget v1, Landroid/support/v7/a/a$a;->actionBarTabStyle:I

    invoke-static {p2, v3, v0, v1, v2}, Landroid/support/v7/widget/al;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/al;

    move-result-object v0

    .line 394
    invoke-virtual {v0, v2}, Landroid/support/v7/widget/al;->f(I)Z
    ...
    invoke-virtual {p0, v1}, Landroid/support/v7/widget/ae$c;->setBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {p0, v0}, Landroid/support/v7/widget/ae$c;->setGravity(I)V
...
.method public a()V
    ...
    .line 447
    iget-object v3, p0, Landroid/support/v7/widget/ae$c;->c:Landroid/support/v7/app/a$b;
    ...
    .line 453
    :cond_0
    invoke-virtual {p0, v4}, Landroid/support/v7/widget/ae$c;->addView(Landroid/view/View;)V

    .line 455
    :cond_1
    iput-object v4, p0, Landroid/support/v7/widget/ae$c;->f:Landroid/view/View;
    ...
    .line 462
    :cond_4
    iget-object v0, p0, Landroid/support/v7/widget/ae$c;->f:Landroid/view/View;
    ...
    invoke-virtual {p0, v0}, Landroid/support/v7/widget/ae$c;->removeView(Landroid/view/View;)V
    ...
    .line 471
    iget-object v5, p0, Landroid/support/v7/widget/ae$c;->e:Landroid/widget/ImageView;
    ...
    invoke-direct {v5, v6}, Landroid/support/v7/widget/l;-><init>(Landroid/content/Context;)V

    .line 473
    new-instance v6, Landroid/support/v7/widget/x$a;

    invoke-direct {v6, v8, v8}, Landroid/support/v7/widget/x$a;-><init>(II)V

    .line 475
    iput v9, v6, Landroid/support/v7/widget/x$a;->h:I

    .line 476
    invoke-virtual {v5, v6}, Landroid/widget/ImageView;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V

    .line 477
    invoke-virtual {p0, v5, v2}, Landroid/support/v7/widget/ae$c;->addView(Landroid/view/View;I)V

    .line 478
    iput-object v5, p0, Landroid/support/v7/widget/ae$c;->e:Landroid/widget/ImageView;
    ...
    .line 489
    iget-object v5, p0, Landroid/support/v7/widget/ae$c;->d:Landroid/widget/TextView;
    ...
    .line 497
    invoke-virtual {p0, v5}, Landroid/support/v7/widget/ae$c;->addView(Landroid/view/View;)V

    .line 498
    iput-object v5, p0, Landroid/support/v7/widget/ae$c;->d:Landroid/widget/TextView;
    ...
    :goto_4
    invoke-static {p0, v0}, Landroid/support/v7/widget/an;->a(Landroid/view/View;Ljava/lang/CharSequence;)V
...
.method public onMeasure(II)V
    ...
    iget v1, v1, Landroid/support/v7/widget/ae;->c:I
...
.method public setSelected(Z)V
    ...
    invoke-virtual {p0, v0}, Landroid/support/v7/widget/ae$c;->sendAccessibilityEvent(I)V
