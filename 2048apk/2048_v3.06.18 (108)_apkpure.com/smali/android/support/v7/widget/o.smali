...
.method constructor <init>(Landroid/widget/TextView;)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/o;->f:Landroid/support/v7/widget/r;
...
.method private a(Landroid/content/Context;Landroid/support/v7/widget/al;)V
    .locals 3
    ...
    iget v1, p0, Landroid/support/v7/widget/o;->g:I

    invoke-virtual {p2, v0, v1}, Landroid/support/v7/widget/al;->a(II)I
    ...
    invoke-virtual {p2, v0}, Landroid/support/v7/widget/al;->f(I)Z
    ...
    iput-object v0, p0, Landroid/support/v7/widget/o;->h:Landroid/graphics/Typeface;
    ...
    invoke-virtual {p2, v0, v1, v2}, Landroid/support/v7/widget/al;->a(IILandroid/widget/TextView;)Landroid/graphics/Typeface;

    move-result-object v1

    iput-object v1, p0, Landroid/support/v7/widget/o;->h:Landroid/graphics/Typeface;
    :try_end_0
    ...
    :cond_1
    :goto_1
    iget-object v1, p0, Landroid/support/v7/widget/o;->h:Landroid/graphics/Typeface;

    if-nez v1, :cond_2

    .line 215
    invoke-virtual {p2, v0}, Landroid/support/v7/widget/al;->c(I)Ljava/lang/String;
...
.method a(Landroid/content/Context;I)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/al;->f(I)Z
    ...
    .line 236
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/al;->d(I)Landroid/content/res/ColorStateList;
    ...
    .line 242
    :cond_1
    invoke-direct {p0, p1, v0}, Landroid/support/v7/widget/o;->a(Landroid/content/Context;Landroid/support/v7/widget/al;)V

    .line 243
    invoke-virtual {v0}, Landroid/support/v7/widget/al;->a()V

    .line 244
    iget-object v0, p0, Landroid/support/v7/widget/o;->h:Landroid/graphics/Typeface;
...
.method a(Landroid/util/AttributeSet;I)V
    ...
    invoke-static {v7, p1, v3, p2, v2}, Landroid/support/v7/widget/al;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/al;
    ...
    invoke-virtual {v3, v4, v9}, Landroid/support/v7/widget/al;->g(II)I
    ...
    .line 75
    invoke-virtual {v3, v6, v2}, Landroid/support/v7/widget/al;->g(II)I

    move-result v6

    .line 74
    invoke-static {v7, v0, v6}, Landroid/support/v7/widget/o;->a(Landroid/content/Context;Landroid/support/v7/widget/h;I)Landroid/support/v7/widget/aj;

    move-result-object v6

    iput-object v6, p0, Landroid/support/v7/widget/o;->b:Landroid/support/v7/widget/aj;
    ...
    iput-object v6, p0, Landroid/support/v7/widget/o;->c:Landroid/support/v7/widget/aj;
    ...
    iput-object v6, p0, Landroid/support/v7/widget/o;->d:Landroid/support/v7/widget/aj;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/o;->e:Landroid/support/v7/widget/aj;
    ...
    invoke-static {v7, v4, v0}, Landroid/support/v7/widget/al;->a(Landroid/content/Context;I[I)Landroid/support/v7/widget/al;
    ...
    invoke-virtual {v9, v0}, Landroid/support/v7/widget/al;->f(I)Z
    ...
    invoke-virtual {v9, v0, v2}, Landroid/support/v7/widget/al;->a(IZ)Z
    ...
    .line 110
    :goto_0
    invoke-direct {p0, v7, v9}, Landroid/support/v7/widget/o;->a(Landroid/content/Context;Landroid/support/v7/widget/al;)V
    ...
    invoke-virtual {v9, v4}, Landroid/support/v7/widget/al;->f(I)Z
    ...
    invoke-virtual {v9, v4}, Landroid/support/v7/widget/al;->d(I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v9, v6}, Landroid/support/v7/widget/al;->f(I)Z
    ...
    invoke-virtual {v9, v6}, Landroid/support/v7/widget/al;->d(I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v9, v10}, Landroid/support/v7/widget/al;->f(I)Z
    ...
    invoke-virtual {v9, v5}, Landroid/support/v7/widget/al;->d(I)Landroid/content/res/ColorStateList;
    ...
    :cond_4
    :goto_3
    invoke-virtual {v9}, Landroid/support/v7/widget/al;->a()V

    .line 130
    :goto_4
    sget-object v9, Landroid/support/v7/a/a$j;->TextAppearance:[I

    invoke-static {v7, p1, v9, p2, v2}, Landroid/support/v7/widget/al;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/al;
    ...
    invoke-virtual {v9, v1}, Landroid/support/v7/widget/al;->f(I)Z
    ...
    invoke-virtual {v9, v1}, Landroid/support/v7/widget/al;->d(I)Landroid/content/res/ColorStateList;
    ...
    .line 165
    invoke-virtual {p0, v3}, Landroid/support/v7/widget/o;->a(Z)V
    ...
    iget-object v1, p0, Landroid/support/v7/widget/o;->f:Landroid/support/v7/widget/r;
    ...
    iget-object v3, p0, Landroid/support/v7/widget/o;->f:Landroid/support/v7/widget/r;
    ...
    iget-object v4, p0, Landroid/support/v7/widget/o;->f:Landroid/support/v7/widget/r;
