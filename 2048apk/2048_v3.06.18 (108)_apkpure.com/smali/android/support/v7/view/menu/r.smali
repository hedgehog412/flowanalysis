...
.method public constructor <init>(Landroid/content/Context;Landroid/support/v7/view/menu/g;Landroid/view/View;IIZ)V
    ...
    invoke-direct {v1, p2, v0, v2}, Landroid/support/v7/view/menu/f;-><init>(Landroid/support/v7/view/menu/g;Landroid/view/LayoutInflater;Z)V

    iput-object v1, p0, Landroid/support/v7/view/menu/r;->e:Landroid/support/v7/view/menu/f;
    ...
    iput-object v0, p0, Landroid/support/v7/view/menu/r;->a:Landroid/support/v7/widget/ab;
...
.method private h()Z
    ...
    invoke-virtual {v0, v2}, Landroid/support/v7/widget/ab;->a(Z)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/ab;->g(I)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/ab;->a(Landroid/graphics/Rect;)V
...
.method public a(Landroid/support/v7/view/menu/s;)Z
    ...
    .line 273
    iget-object v1, p0, Landroid/support/v7/view/menu/r;->a:Landroid/support/v7/widget/ab;

    invoke-virtual {v1}, Landroid/support/v7/widget/ab;->j()I
    ...
    invoke-virtual {v2}, Landroid/support/v7/widget/ab;->k()I
