...
.method private b()Landroid/view/View;
    ...
    invoke-virtual {v3}, Landroid/support/v7/widget/al$i;->d()Z
    ...
    invoke-virtual {v3}, Landroid/support/v7/widget/al$i;->f()I
...
.method public b(Landroid/view/View;)Landroid/view/View;
    ...
    iget-object v4, v4, Landroid/support/v7/widget/al$w;->a:Landroid/view/View;

    invoke-virtual {v4}, Landroid/view/View;->getLayoutParams()Landroid/view/ViewGroup$LayoutParams;

    move-result-object v5

    check-cast v5, Landroid/support/v7/widget/al$i;

    if-eq v4, p1, :cond_3

    invoke-virtual {v5}, Landroid/support/v7/widget/al$i;->d()Z
    ...
    :cond_0
    invoke-virtual {v5}, Landroid/support/v7/widget/al$i;->f()I
