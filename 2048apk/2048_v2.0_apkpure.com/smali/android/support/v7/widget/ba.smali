...
.method public constructor <init>(Landroid/support/v7/widget/Toolbar;ZII)V
    ...
    iput p4, p0, Landroid/support/v7/widget/ba;->m:I

    iput p4, p0, Landroid/support/v7/widget/ba;->n:I
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ba;->b:Ljava/lang/CharSequence;
    ...
    iget-object v0, p0, Landroid/support/v7/widget/ba;->b:Ljava/lang/CharSequence;
    ...
    :goto_0
    iput-boolean v0, p0, Landroid/support/v7/widget/ba;->j:Z

    invoke-virtual {p1}, Landroid/support/v7/widget/Toolbar;->getNavigationIcon()Landroid/graphics/drawable/Drawable;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v7/widget/ba;->i:Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p1, v0, v1, v2, p4}, Landroid/support/v7/widget/az;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/az;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ba;->o:Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, p2}, Landroid/support/v7/widget/ba;->b(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p0, p2}, Landroid/support/v7/widget/ba;->c(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p0, p2}, Landroid/support/v7/widget/ba;->b(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {p0, p2}, Landroid/support/v7/widget/ba;->a(Landroid/graphics/drawable/Drawable;)V

    :cond_4
    iget-object p2, p0, Landroid/support/v7/widget/ba;->i:Landroid/graphics/drawable/Drawable;

    if-nez p2, :cond_5

    iget-object p2, p0, Landroid/support/v7/widget/ba;->o:Landroid/graphics/drawable/Drawable;

    if-eqz p2, :cond_5

    iget-object p2, p0, Landroid/support/v7/widget/ba;->o:Landroid/graphics/drawable/Drawable;

    invoke-virtual {p0, p2}, Landroid/support/v7/widget/ba;->c(Landroid/graphics/drawable/Drawable;)V

    :cond_5
    sget p2, Landroid/support/v7/a/a$j;->ActionBar_displayOptions:I

    invoke-virtual {p1, p2, p4}, Landroid/support/v7/widget/az;->a(II)I

    move-result p2

    invoke-virtual {p0, p2}, Landroid/support/v7/widget/ba;->d(I)V

    sget p2, Landroid/support/v7/a/a$j;->ActionBar_customNavigationLayout:I

    invoke-virtual {p1, p2, p4}, Landroid/support/v7/widget/az;->g(II)I
    ...
    invoke-virtual {p0, p2}, Landroid/support/v7/widget/ba;->a(Landroid/view/View;)V

    iget p2, p0, Landroid/support/v7/widget/ba;->e:I
    ...
    invoke-virtual {p1, p2, p4}, Landroid/support/v7/widget/az;->f(II)I
    ...
    invoke-virtual {p1, v1, v0}, Landroid/support/v7/widget/az;->d(II)I
    ...
    iget-object p4, p0, Landroid/support/v7/widget/ba;->a:Landroid/support/v7/widget/Toolbar;
    ...
    :cond_c
    invoke-direct {p0}, Landroid/support/v7/widget/ba;->c()I

    move-result p2

    iput p2, p0, Landroid/support/v7/widget/ba;->e:I

    :cond_d
    :goto_1
    invoke-virtual {p1}, Landroid/support/v7/widget/az;->a()V

    invoke-virtual {p0, p3}, Landroid/support/v7/widget/ba;->c(I)V
...
.method public a(Landroid/view/View;)V
    ...
    iget-object v1, p0, Landroid/support/v7/widget/ba;->f:Landroid/view/View;
    ...
    iget p1, p0, Landroid/support/v7/widget/ba;->e:I
...
.method public b(I)V
    ...
    :goto_0
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/ba;->b(Landroid/graphics/drawable/Drawable;)V
...
.method public c(I)V
    ...
    iget v0, p0, Landroid/support/v7/widget/ba;->n:I
    ...
    :cond_0
    iput p1, p0, Landroid/support/v7/widget/ba;->n:I
    ...
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/ba;->e(I)V
...
.method public c(Landroid/graphics/drawable/Drawable;)V
    ...
    iput-object p1, p0, Landroid/support/v7/widget/ba;->i:Landroid/graphics/drawable/Drawable;
...
.method public e(I)V
    ...
    :goto_0
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/ba;->d(Ljava/lang/CharSequence;)V
