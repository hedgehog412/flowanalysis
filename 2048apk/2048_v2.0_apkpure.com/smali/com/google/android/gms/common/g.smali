...
.method private final a(Landroid/content/Context;ILjava/lang/String;Landroid/app/PendingIntent;)V
    ...
    invoke-static {}, Lcom/google/android/gms/common/util/q;->i()Z
    ...
    :cond_5
    new-instance v4, Landroid/support/v4/app/y$c;

    invoke-direct {v4, p1}, Landroid/support/v4/app/y$c;-><init>(Landroid/content/Context;)V

    const v6, 0x108008a

    invoke-virtual {v4, v6}, Landroid/support/v4/app/y$c;->a(I)Landroid/support/v4/app/y$c;
    ...
    invoke-virtual {v4, v2}, Landroid/support/v4/app/y$c;->c(Ljava/lang/CharSequence;)Landroid/support/v4/app/y$c;
    ...
    invoke-virtual {v2, v6, v7}, Landroid/support/v4/app/y$c;->a(J)Landroid/support/v4/app/y$c;

    move-result-object v2

    invoke-virtual {v2, v5}, Landroid/support/v4/app/y$c;->a(Z)Landroid/support/v4/app/y$c;

    move-result-object v2

    invoke-virtual {v2, p4}, Landroid/support/v4/app/y$c;->a(Landroid/app/PendingIntent;)Landroid/support/v4/app/y$c;

    move-result-object p4

    invoke-virtual {p4, v0}, Landroid/support/v4/app/y$c;->a(Ljava/lang/CharSequence;)Landroid/support/v4/app/y$c;

    move-result-object p4

    invoke-virtual {p4, v1}, Landroid/support/v4/app/y$c;->b(Ljava/lang/CharSequence;)Landroid/support/v4/app/y$c;

    move-result-object p4

    invoke-virtual {p4, v5}, Landroid/support/v4/app/y$c;->b(Z)Landroid/support/v4/app/y$c;
    ...
    invoke-virtual {v0, v1}, Landroid/support/v4/app/y$b;->a(Ljava/lang/CharSequence;)Landroid/support/v4/app/y$b;

    move-result-object v0

    invoke-virtual {p4, v0}, Landroid/support/v4/app/y$c;->a(Landroid/support/v4/app/y$d;)Landroid/support/v4/app/y$c;
    ...
    invoke-virtual {p4, p1}, Landroid/support/v4/app/y$c;->a(Ljava/lang/String;)Landroid/support/v4/app/y$c;

    :cond_6
    invoke-virtual {p4}, Landroid/support/v4/app/y$c;->a()Landroid/app/Notification;
